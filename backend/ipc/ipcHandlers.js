...
function registerIpcHandlers() {
    ...
    ipcMain.handle('billing:deleteInvoice', (event, id, ownerPin) =>
        billingService.deleteInvoice(id, ownerPin)
    );
    ipcMain.handle('billing:deleteInvoices', (event, ids, ownerPin) =>
        billingService.deleteInvoices(ids, ownerPin)
    );
